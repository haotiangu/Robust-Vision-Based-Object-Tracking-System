...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input', type=str, default='experiments/pretrained_models/FPRN_x4plus.pth', help='Input model path')
    parser.add_argument('--output', type=str, default='fprn-x4.onnx', help='Output onnx path')
